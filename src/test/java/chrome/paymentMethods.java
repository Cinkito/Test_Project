...
public class paymentMethods {
    ...
    public void rejectedPaymentWith3DSecure2Test() {
        ...
        switchToFrame(secureAuthorizeFrame);
        switchToFrame(secondStepSecure);
        wait.until(ExpectedConditions.elementToBeClickable(failButton)).click();
        driver.switchTo().defaultContent();
    ...
    private void fillFormFields() {
        ...
        driver.findElement(By.cssSelector("#billing_phone")).sendKeys("555444333");
        driver.findElement(By.cssSelector("#billing_email")).sendKeys("testaccount123test@testtest.com");
